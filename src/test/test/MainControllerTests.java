...
public class MainControllerTests {
 ...
 @Autowired
    ...
    public void ShouldReturnMessageList() throws Exception {
        ...
        System.out.println(  this.mockMvc.perform(get("http://localhost:8080/goChatMe/chat/messages").param("channelID","1"))
                .andDo(print()).andExpect(status().isOk()).andExpect(jsonPath("$").isArray()).andReturn());
